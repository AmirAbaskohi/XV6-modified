...
main(void)
{
  ...
  23:	79 20                	jns    45 <main+0x45>
    mknod("console", 1, 1);
  25:	53                   	push   %ebx
  26:	6a 01                	push   $0x1
  28:	6a 01                	push   $0x1
  2a:	68 88 08 00 00       	push   $0x888
  2f:	e8 b6 03 00 00       	call   3ea <mknod>
    open("console", O_RDWR);
  34:	58                   	pop    %eax
  35:	5a                   	pop    %edx
  36:	6a 02                	push   $0x2
  38:	68 88 08 00 00       	push   $0x888
  3d:	e8 a0 03 00 00       	call   3e2 <open>
  42:	83 c4 10             	add    $0x10,%esp
  }
  dup(0);  // stdout
  45:	83 ec 0c             	sub    $0xc,%esp
  48:	6a 00                	push   $0x0
  4a:	e8 cb 03 00 00       	call   41a <dup>
  dup(0);  // stderr
  4f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  56:	e8 bf 03 00 00       	call   41a <dup>

  pid = fork();
  5b:	e8 3a 03 00 00       	call   39a <fork>
  if(pid < 0){
  60:	83 c4 10             	add    $0x10,%esp
  63:	85 c0                	test   %eax,%eax
  65:	0f 88 90 00 00 00    	js     fb <main+0xfb>
    printf(1, "trace_syscalls: fork failed\n");
    exit();
  }
  if(pid == 0){
  6b:	74 73                	je     e0 <main+0xe0>
    exit();
  }
  ...
  75:	6a 01                	push   $0x1
  77:	e8 b4 04 00 00       	call   530 <printf>
    printf(1,"Sina Salimian\n");
  7c:	58                   	pop    %eax
  7d:	5a                   	pop    %edx
  7e:	68 c0 08 00 00       	push   $0x8c0
  83:	6a 01                	push   $0x1
  85:	e8 a6 04 00 00       	call   530 <printf>
    printf(1,"Amirhossein Abbaskuhi\n");
  8a:	59                   	pop    %ecx
  8b:	5b                   	pop    %ebx
  8c:	68 cf 08 00 00       	push   $0x8cf
  91:	6a 01                	push   $0x1
  93:	e8 98 04 00 00       	call   530 <printf>
    printf(1,"Arash Rasouli\n");
  98:	58                   	pop    %eax
  99:	5a                   	pop    %edx
  9a:	68 e6 08 00 00       	push   $0x8e6
  9f:	6a 01                	push   $0x1
  a1:	e8 8a 04 00 00       	call   530 <printf>
    pid = fork();
  a6:	e8 ef 02 00 00       	call   39a <fork>
    if(pid < 0){
  ...
  b0:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  b2:	78 5a                	js     10e <main+0x10e>
      printf(1, "init: fork failed\n");
      exit();
    }
    if(pid == 0){
  b4:	74 6b                	je     121 <main+0x121>
      exec("sh", argv);
      printf(1, "init: exec sh failed\n");
      exit();
    }
    while((wpid=wait()) >= 0 && wpid != pid)
  b6:	e8 ef 02 00 00       	call   3aa <wait>
  bb:	85 c0                	test   %eax,%eax
  bd:	78 ae                	js     6d <main+0x6d>
  bf:	39 c3                	cmp    %eax,%ebx
  c1:	74 aa                	je     6d <main+0x6d>
      printf(1, "zombie!\n");
  c3:	83 ec 08             	sub    $0x8,%esp
  c6:	68 21 09 00 00       	push   $0x921
  cb:	6a 01                	push   $0x1
  cd:	e8 5e 04 00 00       	call   530 <printf>
  d2:	83 c4 10             	add    $0x10,%esp
  d5:	eb df                	jmp    b6 <main+0xb6>
  d7:	89 f6                	mov    %esi,%esi
  d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    trace_syscalls(0);
  e0:	83 ec 0c             	sub    $0xc,%esp
  e3:	6a 00                	push   $0x0
  e5:	e8 60 03 00 00       	call   44a <trace_syscalls>
    sleep(505);
  ea:	c7 04 24 f9 01 00 00 	movl   $0x1f9,(%esp)
  f1:	e8 3c 03 00 00       	call   432 <sleep>
  f6:	83 c4 10             	add    $0x10,%esp
  f9:	eb e5                	jmp    e0 <main+0xe0>
    printf(1, "trace_syscalls: fork failed\n");
  fb:	51                   	push   %ecx
  fc:	51                   	push   %ecx
  fd:	68 90 08 00 00       	push   $0x890
 102:	6a 01                	push   $0x1
 104:	e8 27 04 00 00       	call   530 <printf>
    exit();
 109:	e8 94 02 00 00       	call   3a2 <exit>
      printf(1, "init: fork failed\n");
 10e:	53                   	push   %ebx
 10f:	53                   	push   %ebx
 110:	68 f5 08 00 00       	push   $0x8f5
 115:	6a 01                	push   $0x1
 117:	e8 14 04 00 00       	call   530 <printf>
      exit();
 11c:	e8 81 02 00 00       	call   3a2 <exit>
      exec("sh", argv);
 121:	50                   	push   %eax
 122:	50                   	push   %eax
 123:	68 dc 0b 00 00       	push   $0xbdc
 128:	68 08 09 00 00       	push   $0x908
 12d:	e8 a8 02 00 00       	call   3da <exec>
      printf(1, "init: exec sh failed\n");
 132:	5a                   	pop    %edx
 133:	59                   	pop    %ecx
 134:	68 0b 09 00 00       	push   $0x90b
 139:	6a 01                	push   $0x1
 13b:	e8 f0 03 00 00       	call   530 <printf>
      exit();
 140:	e8 5d 02 00 00       	call   3a2 <exit>
 ...
 499:	85 d2                	test   %edx,%edx
{
 ...
 500:	e8 bd fe ff ff       	call   3c2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 570:	e8 4d fe ff ff       	call   3c2 <write>
 ...
 5d1:	e8 ec fd ff ff       	call   3c2 <write>
 ...
 5e8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ea:	e8 d3 fd ff ff       	call   3c2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 683:	57                   	push   %edi
 684:	53                   	push   %ebx
 685:	e8 38 fd ff ff       	call   3c2 <write>
        while(*s != 0){
 ...
 6d7:	e8 e6 fc ff ff       	call   3c2 <write>
        ap++;
 ...
 6e4:	e9 8f fe ff ff       	jmp    578 <printf+0x48>
          s = "(null)";
 6e9:	bb 2a 09 00 00       	mov    $0x92a,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ee:	56                   	push   %esi
 7ef:	e8 36 fc ff ff       	call   42a <sbrk>
  if(p == (char*)-1)
